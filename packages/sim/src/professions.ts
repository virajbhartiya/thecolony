...
export const PROFESSIONS: ProfessionProfile[] = [
  {
    ...
    title: 'Chef',
    role: 'kitchen lead',
    industries: ['restaurant', 'bar', 'shop', 'farm'],
  ...
  },
  {
    ...
    title: 'Builder',
    role: 'builder',
    industries: ['construction_yard', 'factory', 'town_hall'],
  ...
  },
  {
    ...
    role: 'doctor',
    industries: ['clinic'],
    starting_cash_cents: 15000,
    wage_cents: 2900,
    skill_tags: ['health', 'triage', 'public safety'],
    trait_bias: { conscientiousness: 0.13, empathy: 0.12, neuroticism: -0.03 },
  },
  {
    key: 'teacher',
    title: 'Teacher',
    role: 'teacher',
    industries: ['school'],
    starting_cash_cents: 8800,
    wage_cents: 1900,
    skill_tags: ['education', 'civic memory', 'discipline'],
    trait_bias: { agreeableness: 0.1, conscientiousness: 0.1, sociability: 0.06 },
  },
  {
    key: 'reporter',
    title: 'Reporter',
    role: 'reporter',
    industries: ['newsroom', 'office'],
    starting_cash_cents: 7200,
    wage_cents: 1800,
    skill_tags: ['news', 'gossip', 'investigation'],
    trait_bias: { openness: 0.1, sociability: 0.1, paranoia: 0.08 },
  },
  {
    key: 'courier',
    title: 'Courier',
    role: 'courier',
    industries: ['shop', 'restaurant', 'office'],
    starting_cash_cents: 6200,
    wage_cents: 1600,
    skill_tags: ['delivery', 'streets', 'errands'],
    trait_bias: { extraversion: 0.06, risk: 0.06, conscientiousness: 0.03 },
  },
  {
    key: 'mechanic',
    title: 'Mechanic',
    role: 'mechanic',
    industries: ['factory', 'water_works', 'power_plant', 'construction_yard'],
    starting_cash_cents: 9000,
    wage_cents: 2200,
    skill_tags: ['machines', 'repairs', 'utilities'],
    trait_bias: { conscientiousness: 0.1, openness: 0.05, sociability: -0.02 },
  },
  {
    key: 'artist',
    title: 'Artist',
